...
| H04 | HIL evidence hardening | Extends the merged one-phone runner with per-run SSH trust, exact mesh identity matching, honest controller-unavailable evidence, remote-device seams, and validated promotion. |
...
5. Android Device Streaming or another remote-physical-device pilot using H04's hardened runner.
