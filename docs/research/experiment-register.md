...
| F02 | 2026-07-30 | `docs/research/experiments/F02.md`, PR #12, Actions run `30558283297` | Repository, Android build, package artifact | PASS | Unused migration code is removed, F01 is historical, H02A is the sole active task, and H02B/H03 remain queued. H02A implementation must start separately. |
| H02A | — | `docs/research/experiments/H02A.md` | Linux host QEMU | PLANNED | Qualify canonical UEFI/QMP, NoCloud, key-only loopback SSH, restart, and mesh-free forbidden-material scanning before guest mesh work. |
