...
| F02 | 2026-07-30 | `docs/research/experiments/F02.md` | Repository transition branch | IN_PROGRESS | Remove unused migration code, archive F01, activate only H02A, and validate repository truth before H02A implementation starts. |
