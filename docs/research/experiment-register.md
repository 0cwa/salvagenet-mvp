...
| F02 | 2026-07-30 | `docs/research/experiments/F02.md`, PR #12, merge `e91a3a04bd9fd8aff3a2b512753c96d7753e7659`, Actions run `30569745352` | Repository, Android build, package artifact | PASS | Unused migration code is gone, Podroid/profile contract refinements are integrated, and H02A was prepared as the next product qualification phase. |
| W00 | 2026-07-30 | PR #19, merge `b42c35ac17793fb1621baf19905a0eacea9b3521`, Actions run `30578924509` | Repository and GitHub CI | PASS | Podroid-MVP alignment, static-site/theme architecture, complete roadmap governance, and human-aware task-management contracts are accepted. |
| WEB04 | — | `docs/research/experiments/WEB04.md` | GitHub Issues + repository snapshots | PLANNED | Bootstrap the complete issue graph and compact agent state before website implementation; issue state remains separate from task authorization and acceptance. |
| H02A | — | `docs/research/experiments/H02A.md` | Linux host QEMU | QUEUED_REVIEW | Reactivate after WEB04; qualify canonical UEFI/QMP, NoCloud, key-only loopback SSH, restart, and mesh-free forbidden-material scanning before guest mesh work. |
...
| E07 | 2026-07-29 | `evidence/gates/B06.json`, `B11.json`, `B20.json` | Bootstrap/recovery/redaction tests | SOFTWARE-PASS/GUEST-INSPECTION-OPEN/HARDWARE-OPEN | H02A proves no mesh secrets are introduced in the boot-only flow; actual one-use redemption/erasure moves to H02B and the physical guest slice. |
...
| E11 | — | `docs/roadmap/acceptance-ledger.md` | — | BLOCKED-BASE-MVP | USB remains MVP+ and cannot enter executable scope before every B gate passes. |
