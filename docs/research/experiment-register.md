...
| F02 | 2026-07-30 | `docs/research/experiments/F02.md`, PR #12, earlier validated transition head `ed86c16bb5db49d16ac45eee21b0da97023ecb60`, Actions run `30558283297` | Repository, Android build, package artifact | MERGE_READY | The earlier transition head passed. Final documentation-head validation, review closure, and merge remain pending; H02A is the sole active task and implementation must start separately after merge. |
| H02A | — | `docs/research/experiments/H02A.md` | Linux host QEMU | ACTIVE | Qualify canonical UEFI/QMP, NoCloud, key-only loopback SSH, restart, and mesh-free forbidden-material scanning before guest mesh work. |
