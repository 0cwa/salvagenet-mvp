...
- `../agents/hardware-independent-goal.md` — current phase-boundary protocol, active WEB04 foundation, and queued H02A product task.
- `../agents/tasks/WEB04/task.md` — sole active task, acceptance criteria, checks, and phase-end review.
- `roadmap/podroid-mvp-alignment.md` — original Podroid-fork MVP mapping, deliberate refinements, current product critical path, and drift alarms.
...
- `../lab/qemu/README.md` — Linux host-QEMU laboratory used by queued H02A.
...
- `roadmap/hardware-independent.md` — active WEB04 foundation, queued H02A, expected website/product parallel phase, and physical path.
...
- `research/experiments/WEB04.md` — active roadmap/agent-foundation hypothesis and evidence limits.
- `research/experiments/H02A.md` — queued guest-boot qualification record.
