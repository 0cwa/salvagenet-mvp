...
- `architecture/decisions/ADR-012-static-site-and-roadmap-truth.md` — proposed static-site, design-system, theme, progressive-enhancement, and roadmap-truth decision.
...
- `development/roadmap-agent-workflow.md` — roadmap freshness, compact agent context, and phase-replanning workflow.
